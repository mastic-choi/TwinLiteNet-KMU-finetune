#!/usr/bin/env python3
"""SegFormer(Cityscapes 사전학습, nvidia/segformer-b2-finetuned-cityscapes-1024-1024)
20장 몽타주. Cityscapes 클래스엔 "차선(lane line)"이 따로 없어서 road(da)만 비교."""
import math
import os
...
OUT_PATH = os.path.join(BASE, "outputs", "montages", "segformer_montage.png")
