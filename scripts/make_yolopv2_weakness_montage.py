#!/usr/bin/env python3
"""YOLOPv2(pretrained, 파인튜닝 안 함)가 30장(성공 20+실패 10) 중 da/ll ROI 커버리지가
가장 낮았던 12장만 골라 몽타주로 확인한다."""
import math
import os
import sys
...
OUT_PATH = os.path.join(BASE, "outputs", "montages", "yolopv2_weakness_montage.png")
WEIGHTS = os.path.join(YOLOPV2_DIR, "data", "weights", "yolopv2.pt")
THUMB_W, THUMB_H = 320, 240
ROI_Y0, ROI_Y1 = 250, 390

# da+ll*3 기준 가장 약했던 12장 (30장 중, ll에 가중치를 더 줌 - 차선이 더 얇아서 민감)
WEAK_FRAMES = [
